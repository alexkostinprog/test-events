...
<img src="./screenshots/image-1.png" width="376" height="319" alt="Страница конкретного события" />
...
2. Откройте созданный файл `.env` и вставьте ваш личный API-ключ погодного сервиса Weather.visualcrossing.com в переменную `VITE_WEATHER_API_KEY`.
